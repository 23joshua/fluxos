...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= theme("/assets/images/icon-logo.png", CONF_VIEW_ADMIN); ?>" />
</head>
            ...
            <div class="dash_userbar">
                <div class="dash_userbar_box">
                    <div class="dash_content_box">
                        <h1 class="icon-cog transition"><a href="<?= url("/admin/dash"); ?>">JS Brilliant Mind
                                |<b> Admin</b></a></h1>
