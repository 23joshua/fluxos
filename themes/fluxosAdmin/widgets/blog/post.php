                ...
                <div class="label_g2">
                    <label class="label">
                        ...
                        <select name="category" required>
                            <?php foreach ($categories as $category):
                                ...
                                $select = function ($thisalue) use ($categoryId) {
                                    return ($categoryId == $thisalue ? "selected" : "");
                                };
                                ?>
                    ...
                    <label class="label">
                        ...
                        <select name="author" required>
                            <?php foreach ($authors as $author):
                                $authorId = $author->id;
                                $select = function ($thisalue) use ($authorId) {
                                    return ($authorId == $thisalue ? "selected" : "");
                                };
                                ?>
                ...
                <div class="label_g2">
                    <label class="label">
                        ...
                        <select name="status" required>
                            <?php
                            $status = $post->status;
                            $select = function ($thisalue) use ($status) {
                    ...
                    <label class="label">
                        <span class="legend">Data de publicação:</span>
                        <input class="mask-datetime" type="text" name="post_at" value="<?= 
                        date_fmt($post->post_at, "d/m/Y H:i"); ?>"
                               required/>
                    </label>
                </div>
