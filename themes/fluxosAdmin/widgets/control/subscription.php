...
<?php $this->insert("widgets/control/sidebar", ["app" => $app]); ?>
                ...
                <label class="label">
                    ...
                    <select name="plan_id" required>
                        <?php foreach ($plans as $plan):
                            ...
                            $selected = function ($thisalue) use ($plan_id) {
                                return ($plan_id == $thisalue ? "selected" : "");
                            };
                            ?>
                    ...
                    <select name="card_id" required>
                        <?php if ($cards): var_dump($cards) ?>
                            <?php foreach ($cards as $card):
                                ...
                                $selected = function ($thisalue) use ($card_id) {
                                    return ($card_id == $thisalue ? "selected" : "");
                                };
                                ?>
            ...
            <div class="label_g2">
                <label class="label">
                    ...
                    <select name="status" required>
                        ...
                        $selected = function ($thisalue) use ($status) {
                            return ($status == $thisalue ? "selected" : "");
                        };
                        ?>
                ...
                <label class="label">
                    ...
                    <select name="pay_status" required>
                        ...
                        $selected = function ($thisalue) use ($pay_status) {
                            return ($pay_status == $thisalue ? "selected" : "");
                        };
                        ?>
                        <option <?= $selected("active"); ?> value="active">Ativa</option>
            ...
            <label class="label">
                ...
                <select name="due_day" required>
                    <?php for ($day = 1; $day <= 28; $day++):
                        ...
                        $selected = function ($thisalue) use ($due_day) {
                            return ($due_day == $thisalue ? "selected" : "");
                        };
                        ?>
