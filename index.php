...
$route->get("/servico", "Web:services");
$route->get("/branding", "Web:branding");
$route->get("/google-ads", "Web:googleads");
$route->get("/facebook-ads", "Web:facebookads");
$route->get("/email-marketing", "Web:mailmark");
$route->get("/website", "Web:website");
$route->get("/inbound-marketing", "Web:inbound");
$route->get("/marketing-digital", "Web:marketingdigital");
$route->get("/seo", "Web:seo");
$route->get("/marketing-conteudo", "Web:marketingconteudo");
$route->get("/contacto", "Web:contacte");
